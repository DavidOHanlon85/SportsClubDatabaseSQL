...
ALTER TABLE `ticket`
  ...
  ADD KEY `FK_facility_facility_id_1` (`facility_id`);
...
ALTER TABLE `ticket`
  ...
  ADD CONSTRAINT `FK_facility_facility_id_1` FOREIGN KEY (`facility_id`) REFERENCES `facility` (`facility_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
